...
if (!class_exists('VGTS_Hades')) {
    require_once VGTS_PATH . 'includes/modules/hades/class-vis-hades.php';
}
$hades_instance = new VGTS_Hades([]); 
...
$login_slug   = !empty($opt['hades_login_slug']) ? esc_attr($opt['hades_login_slug']) : 'wp-login.php';
$admin_slug   = !empty($opt['hades_admin_slug']) ? esc_attr($opt['hades_admin_slug']) : 'wp-admin';
...
<div id="vgts-hades-container">
    ...
    <div style="background: rgba(239, 68, 68, 0.05); border-left: 4px solid #ef4444; padding: 15px 20px; margin-bottom: 25px; border-radius: 4px;">
        <strong style="color: #ef4444; display: flex; align-items: center; gap: 8px; margin-bottom: 8px;">
            <span class="dashicons dashicons-warning"></span> 
            <span class="vgts-lang-de" style="display:inline;">WP.ORG RICHTLINIE 10 HINWEIS: "SECURITY BY OBSCURITY"</span>
            <span class="vgts-lang-en" style="display:inline;">WP.ORG GUIDELINE 10 NOTICE: "SECURITY BY OBSCURITY"</span>
        </strong>
        <div class="vgts-lang-de" style="color: #cbd5e1; font-size: 13px; line-height: 1.5;">
            "Security by Obscurity" ist kein Ersatz für echte Sicherheit. Dieses Modul schreibt dynamisch Core-Pfade um, um automatisiertes Scanner-Rauschen zu verringern. Es handelt sich um eine <strong>experimentelle Opt-In-Funktion</strong>, die mit bestimmten CDNs, Caching-Plugins oder hartkodierten Themes in Konflikt geraten kann. Nutzung auf eigene Gefahr.
        </div>
        <div class="vgts-lang-en" style="color: #cbd5e1; font-size: 13px; line-height: 1.5;">
            "Security by obscurity" is not a replacement for actual security. This module dynamically rewrites core paths to reduce automated scanner noise. It is an <strong>experimental opt-in feature</strong> and may conflict with certain CDNs, caching plugins, or hardcoded themes. Use strictly at your own risk.
        </div>
    </div>
    ...
    <div class="vgts-card" style="border-top: 3px solid #8b5cf6;">
        ...
        <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 20px; padding-bottom: 15px; border-bottom: 1px solid var(--vgts-border);">
            ...
            <div>
                ...
                <p class="vgts-lang-de" style="margin: 5px 0 0 0; color: var(--vgts-text-secondary); font-size: 12px;">Camouflage, Pfad-Verschleierung & Ghost Mode</p>
                <p class="vgts-lang-en" style="margin: 5px 0 0 0; color: var(--vgts-text-secondary); font-size: 12px;">Camouflage, Path Obfuscation & Ghost Mode</p>
            </div>
        </div>
        ...
        <div style="background: rgba(15, 23, 42, 0.4); border: 1px solid var(--vgts-border); border-radius: 8px; padding: 20px; margin-bottom: 30px;">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                <div>
                    ...
                    <p class="vgts-lang-de" style="margin: 0; color: var(--vgts-text-secondary); font-size: 12px;">Aktiviert die globale Maskierung von Systempfaden und blockiert direkte Zugriffe auf den Core.</p>
                    <p class="vgts-lang-en" style="margin: 0; color: var(--vgts-text-secondary); font-size: 12px;">Activates global masking of system paths and unconditionally blocks direct access to the core.</p>
                </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr; gap: 8px;">
                ...
                <div class="vgts-matrix-row">
                    <div style="display: flex; align-items: center; gap: 10px; width: 45%;">
                        ...
                        <code style="color: #ef4444; background: transparent; padding: 0; font-size: 13px; border: none;">/<?php echo esc_html($mapping['old']); ?></code>
                    </div>
                    ...
                    <div style="display: flex; align-items: center; gap: 10px; width: 45%; justify-content: flex-end;">
                        <code style="color: #10b981; background: transparent; padding: 0; font-size: 13px; font-weight: 700; border: none;">/<?php echo esc_html($mapping['new']); ?></code>
        ...
        <div style="padding-top: 20px; border-top: 1px solid var(--vgts-border);">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                <div>
                    ...
                    <p class="vgts-lang-de" style="margin: 3px 0 0 0; color: var(--vgts-text-secondary); font-size: 12px;">Ersetzt <code>wp-login.php</code></p>
                    <p class="vgts-lang-en" style="margin: 3px 0 0 0; color: var(--vgts-text-secondary); font-size: 12px;">Replaces <code>wp-login.php</code></p>
                </div>
                <div>
            ...
            <div style="display: flex; justify-content: space-between; align-items: center;">
                <div>
                    ...
                    <p class="vgts-lang-de" style="margin: 3px 0 0 0; color: var(--vgts-text-secondary); font-size: 12px;">Ersetzt <code>wp-admin</code> <strong style="color:#f59e0b;">(Vorsicht: Kann externe Plugins stören!)</strong></p>
                    <p class="vgts-lang-en" style="margin: 3px 0 0 0; color: var(--vgts-text-secondary); font-size: 12px;">Replaces <code>wp-admin</code> <strong style="color:#f59e0b;">(Warning: May disrupt external plugins!)</strong></p>
                </div>
                <div>
        ...
        <?php if ($is_nginx && $hades_active): ?>
            <div style="margin-top:30px; padding:20px; background:rgba(245, 158, 11, 0.05); border:1px solid rgba(245, 158, 11, 0.3); border-radius:6px;">
                <div style="display:flex; gap:10px; color:#f59e0b; margin-bottom:10px; align-items: center;">
                    ...
                    <strong class="vgts-lang-de" style="font-size:14px; letter-spacing: 0.5px; display:inline;">NGINX DETECTED - MANUELLE KONFIGURATION NÖTIG</strong>
                    <strong class="vgts-lang-en" style="font-size:14px; letter-spacing: 0.5px; display:inline;">NGINX DETECTED - MANUAL CONFIGURATION REQUIRED</strong>
                </div>
...
<?php echo esc_textarea($hades_instance->get_nginx_routing_rules()); ?>
</textarea>
            </div>
        <?php endif; ?>
        ...
        <?php if (!$is_nginx && $hades_active): ?>
             <div style="margin-top:30px; padding:15px 20px; background:rgba(16, 185, 129, 0.05); border:1px solid rgba(16, 185, 129, 0.2); border-radius:6px; color:#10b981; font-size:13px; display: flex; align-items: center; gap: 10px;">
                ...
                <div>
                    ...
                    <span class="vgts-lang-de">Routing & Asset Rules wurden erfolgreich in die System-<code>.htaccess</code> injiziert.</span>
                    <span class="vgts-lang-en">Routing & asset rules have been successfully injected into the system <code>.htaccess</code>.</span>
                </div>
            </div>
        <?php endif; ?>
    </div>
